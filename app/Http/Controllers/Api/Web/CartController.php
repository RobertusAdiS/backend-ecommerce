...
class CartController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //check if product alredy in chart and increment qty
        if ($item->count()) {
            $item->increment('qty');
            $item = $item->first();
